...
import GenerarCargosView from './views/GenerarCargosView.vue'; // <-- VISTA NUEVA
  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'alumnos/:id/generar-cargos', name: 'generar-cargos', component: GenerarCargosView }, // <-- RUTA NUEVA
